...
![2024-01-02_10-16](assets/419821610240143.png)
  
  
对于这种多行宏定义，每行结尾要加 \ 表示该行未结束
  
::: alert-danger
若使用 \ 表示该行未完结务必注意 \ 后不能加任何字符，尤其是空格或者Tab。报错如下![2024-01-02_12-05](assets/481670512259271.png)
:::
    
![2024-01-02_10-44](assets/400010311258569.png)
  
![2024-01-02_11-04](assets/7600511266602.png)
...
![2024-01-13_13-36](assets/434673613240154.png)


![2024-01-04_09-41](assets/386434109258571.png)  
...
![2024-01-04_14-42](assets/5864314266604.png)
向量表最前面是MSP的地址
...
![内核的优先级翻转](assets/241410816255828.png)  

![任务正常执行](assets/295570916251582.png)  
...
![2024-01-05_10-23](assets/555312310258572.png)

![2024-01-05_10-23_1](assets/334622310240146.png)
...
![调度器的实现](assets/363240921259275.png)
...
![2024-01-12_10-19](assets/100532010240153.png)  
...
* Keil编译器有问题，有时候类型符合的赋值编译器不通过，必须类型强转才可编译通过。再或者，虽然已经定义了条件编译但还是对循环引用的头文件报错，这时就需要考虑编译器的问题了，Keil失效的通常的现象和解决办法：
    ...
    * ![2024-01-05_22-35](assets/548533722266605.png)
    * ![2024-01-05_22-36](assets/278363822259274.png)
    * ![2024-01-05_22-37](assets/341003822255829.png)
    * ![2024-01-05_22-33](assets/129063322246439.png)
...
在时基函数调用时会用到
![2024-01-11_19-53](assets/350415319240152.png)  
...
```
![2024-01-11_20-48](assets/175724820240152.png)    
...
![2024-02-06_22-58](assets/570080123240247.png)  
