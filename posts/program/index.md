...
![2024-01-02_10-16](image/419821610240143.webp)
  
  
对于这种多行宏定义，每行结尾要加 \ 表示该行未结束
  
::: alert-danger
若使用 \ 表示该行未完结务必注意 \ 后不能加任何字符，尤其是空格或者Tab。报错如下![2024-01-02_12-05](image/481670512259271.webp)
:::
    
![2024-01-02_10-44](image/400010311258569.webp)
  
![2024-01-02_11-04](image/7600511266602.webp)
...
![2024-01-13_13-36](image/434673613240154.webp)


![2024-01-04_09-41](image/386434109258571.webp)  
...
![2024-01-04_14-42](image/5864314266604.webp)
向量表最前面是MSP的地址
...
![内核的优先级翻转](image/241410816255828.webp)  

![任务正常执行](image/295570916251582.webp)  
...
![2024-01-05_10-23](image/555312310258572.webp)

![2024-01-05_10-23_1](image/334622310240146.webp)
...
![调度器的实现](image/363240921259275.webp)
...
![2024-01-12_10-19](image/100532010240153.webp)  
...
* Keil编译器有问题，有时候类型符合的赋值编译器不通过，必须类型强转才可编译通过。再或者，虽然已经定义了条件编译但还是对循环引用的头文件报错，这时就需要考虑编译器的问题了，Keil失效的通常的现象和解决办法：
    ...
    * ![2024-01-05_22-35](image/548533722266605.webp)
    * ![2024-01-05_22-36](image/278363822259274.webp)
    * ![2024-01-05_22-37](image/341003822255829.webp)
    * ![2024-01-05_22-33](image/129063322246439.webp)
...
在时基函数调用时会用到
![2024-01-11_19-53](image/350415319240152.webp)  
...
```
![2024-01-11_20-48](image/175724820240152.webp)    
...
![2024-02-06_22-58](image/570080123240247.webp)  
