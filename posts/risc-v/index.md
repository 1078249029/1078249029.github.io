...
elf文件大致内容如下
![2025-01-01_21-57](image/78955821256435.webp)
...
![](image/460211113269271.webp)

![](image/69745313265826.webp)

立即数
![](image/167202814261580.webp)

riscv没有subi指令，这是由于subi可以用addi代替

![](image/563603014279460.webp)

![](image/564253514277064.webp)

直接加载一个大数会出现符号问题
![](image/19844314274566.webp)
这时会出现addi x1,x1,0xfff实际上加的是-1的情况

![](image/133624314255807.webp)
![](image/232894314278247.webp)
代码中常用li指令赋值，之后由汇编器进行判断对指令转换成何种形式

![](image/2505814273383.webp)
auipc用于构造相对地址，常用于相对寻址和位置无关码的生成中

![](image/127620115266929.webp)
使用la伪指令后，链接器会自动找到label的地址并替换，最后使用auipc进行寻址

### 逻辑运算指令  

riscv只提供了与，或，异或等指令，并没有直接提供非指令，非指令通过伪指令来提供，实际上它是使用异或来实现的
![](image/426421215260063.webp)
> 如下异或运算
>    10101010
> ^11111111
>    01010101
...
![](image/263142115250593.webp)

算数移位只有右移没有左移，因为左移会把符号位移丢弃
![](image/64892915253097.webp)
...
![](image/95633715262044.webp)

![](image/9334415255538.webp)
内存写指令没有0扩展或者符号扩展是因为磁盘存储单位是字节，不必区分两种扩展

### 条件分支指令  

![](image/552010419282493.webp)

### 无条件跳转指令

![](image/481143220264706.webp)

## 汇编函数调用约定  

**注意：ra存放的是函数返回地址，a0存放的是函数参数和返回值**
![](image/528351521254004.webp)
![](image/546284815250149.webp)
函数参数使用a0-a7传递，返回值使用a0和a1传递

我们在编程时常使用伪指令，尤其是call和ret
![](image/73404121250255.webp)
...
![](image/190901916256656.webp)

![](image/316801916276822.webp)
...
* 全相联映射
* 组相联映射
![](image/594942816261800.webp)

![](image/144242916279680.webp)

![](image/345392916277284.webp)
...
```
![](image/490231512262705.webp)

![](image/28291612267744.webp)
...
虚拟机两阶段的地址映射过程
![](image/338443912261861.webp)

包括宿主机的映射过程
![](image/458113912252192.webp)
